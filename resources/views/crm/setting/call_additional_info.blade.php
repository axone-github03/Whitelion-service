        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Call Additional Info</h4>
                    @include('../crm/setting/comman')

                    <div class="page-title-right">


                        <button id="addBtnData" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasMainMaster" aria-controls="canvasMainMaster"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Call Additional Info</button>


                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasDataLable">
                            <div class="offcanvas-header">
                                <h5 id="canvasDataLable">Call Additional Info</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formData" class="custom-validation" action="{{route('crm.setting.call.additional.info.save')}}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="data_is_textfield" class="form-label">Status</label>
                                                <select id="data_is_textfield" name="data_is_textfield" class="form-control select2-apply">
                                                    <option value="0">None</option>
                                                    <option value="1">Is Text Field</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    var ajaxDataURL = "{{route('crm.setting.call.additional.info.ajax')}}";
    var ajaxDataDetailURL = "{{route('crm.setting.call.additional.info.detail')}}";
    ...
    $("#addBtnData").click(function() {
        ...
        $("#canvasDataLable").html("Add Call Additional Info");
        $("#formData").show();
        $(".loadingcls").hide();
        resetInputForm();
    ...
    function resetInputForm() {
        ...
        $("#data_is_textfield").select2("val", "0");
        ...
        $.ajax({
            ...
            success: function(resultData) {
                if (resultData['status'] == 1) {
                    ...
                    $("#data_is_textfield").select2("val", "" + resultData['data']['is_textfield'] + "");
