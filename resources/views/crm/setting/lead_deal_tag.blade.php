        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Lead & Deal Tag Master</h4>
                    ...
                    <div class="page-title-right">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasMainMasterLable">
                            <div class="offcanvas-header">
                                <h5 id="canvasMainMasterLable">Lead Deal Tag Master</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formMainMaster" class="custom-validation" action="{{route('crm.setting.lead.deal.tag.master.save')}}" method="POST">
                                    @csrf
...
<script type="text/javascript">
    var ajaxProductTagMasterDataURL = '{{route("crm.setting.lead.deal.tag.master.ajax")}}';
    var ajaxProductTagMasterDetailURL = '{{route("crm.setting.lead.deal.tag.master.detail")}}';
    ...
    $("#addBtnMainMaster").click(function() {
        $("#canvasMainMasterLable").html("Add Lead Deal Tag");
        $("#formMainMaster").show();
        $(".loadingcls").hide();
        resetInputForm();
    });
