            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
              <tr>
                <td valign="top" class="bodyContent" mc:edit="body_content">
                  <p>Hi {{$params['first_name']}} {{$params['last_name']}},</p>
                  <p>There was a request to change your password!</p>
                  <p>If you did not make this request then please ignore this email.</p>
                    <p>Otherwise, please click this link to change your password:
                      <a href="{{route('reset.password',$params['reset_password_token'])}}">{{route('reset.password',$params['reset_password_token'])}}</a>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
            <tr>
              <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                 <h6 style="text-align:center;margin-top: 9px;">Whitelion Systems Private Limited</h6>
                <h6 style="text-align:center;">Surat​, India ​</h6>
