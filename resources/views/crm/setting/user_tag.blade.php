        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">User Tag Master</h4>
                    @include('../crm/setting/comman')

                    <div class="page-title-right">
                        <button id="addBtnMainMaster" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasMainMaster" aria-controls="canvasMainMaster"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Add User Tag</button>
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasMainMasterLable">
                            <div class="offcanvas-header">
                                <h5 id="canvasMainMasterLable">User Tag Master</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formMainMaster" class="custom-validation" action="{{route('crm.setting.user.tag.master.save')}}" method="POST">
                                    @csrf
...
<script type="text/javascript">
    var ajaxProductTagMasterDataURL = '{{route("crm.setting.user.tag.master.ajax")}}';
    var ajaxProductTagMasterDetailURL = '{{route("crm.setting.user.tag.master.detail")}}';
    ...
    $("#addBtnMainMaster").click(function() {
        $("#canvasMainMasterLable").html("Add User Tag");
        $("#formMainMaster").show();
        $(".loadingcls").hide();
        resetInputForm();
    });
