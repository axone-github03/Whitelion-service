            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <button id="addBtnData" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasMainMaster" aria-controls="canvasMainMaster"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Meeting Outcome Type</button>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasDataLable">
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formData" class="custom-validation" action="{{route('crm.setting.meeting.outcome.type.save')}}" method="POST">
...
<script type="text/javascript">
    var ajaxDataURL = "{{route('crm.setting.meeting.outcome.type.ajax')}}";
    var ajaxDataDetailURL = "{{route('crm.setting.meeting.outcome.type.detail')}}";
