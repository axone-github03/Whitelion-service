                        ...
                        <div class="tab-content py-4">
                            ...
                            <div class="app-search lead-search-form d-none d-lg-block">
                                <div class="position-relative">
                                    <input type="search" class="form-control" id="input_search" name="input_search"
                                        placeholder="Search...">
                            ...
                            <div class="tab-pane show active lead-list" id="chat">
                                <div>
                                    <ul id="sideBarUI" class="list-unstyled chat-list" data-simplebar
                                        style="background: rgb(255 255 255);max-height: 650px;">
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        var ajaxURLDataList = "{{ route('crm.lead.account.contact.list') }}";
        var ajaxURLDataDatail = "{{ route('crm.lead.account.contact.detail.view') }}";
