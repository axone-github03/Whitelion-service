        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">BHK</h4>
                    @include('../crm/setting/comman')

                    <div class="page-title-right">


                        <button id="addBtnData" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasMainMaster" aria-controls="canvasMainMaster"><i class="bx bx-plus font-size-16 align-middle me-2"></i>BHK </button>


                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasDataLable">
                            <div class="offcanvas-header">
                                <h5 id="canvasDataLable">BHK</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formData" class="custom-validation" action="{{route('crm.setting.bhk.save')}}" method="POST">
...
<script type="text/javascript">
    var ajaxDataURL = "{{route('crm.setting.bhk')}}";
    var ajaxDataDetailURL = "{{route('crm.setting.bhk.detail')}}";
